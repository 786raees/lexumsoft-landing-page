# Tuesday Post — After-Hours Calls Angle

**CTA keyword:** CALLS
**Best time to post:** Tuesday, 7-9 AM or 12-1 PM EST
**Do NOT pin this post** — it's a regular feed post, not a Featured pin.

---

## The Post (~2,800 characters)
...
Full comprehensive prompts with all specs are in: **`linkedin/images/after-hours-post-image-prompts-v2.md`**

### Quick Reference — 4 Concepts

| # | Concept | Platform | Difficulty | Description |
|---|---------|----------|------------|-------------|
| 1 | **The Drain** | Midjourney v6.1 | Medium | Overhead shot of $100 bills spiraling into a sink drain, amber-gold light from below, phone on sink edge |
| 2 | **The Split Second** | Ideogram v3 Design | Medium | Diptych — same van interior, left warm/amber (call answered), right cold/blue (call missed) |
| 3 | **Underwater Gold** (Recommended) | Midjourney v6.1 | Easy | Vintage rotary phone sinking through dark water, golden coins and light particles rising upward |
| 4 | **The 6PM Line** | Midjourney v6.1 | Hard | Bird's-eye aerial, diagonal day/night split, plumber's van on day side, phone monolith on night side |

**Generation priority:** 3 → 1 → 2 → 4
...
- **When someone comments CALLS:** DM within 2 hours. Lead with the ROI math relevant to their market size — ask what their average ticket is and do the math with their actual numbers in the DM.
- **Do not edit the post body after publishing.** LinkedIn suppresses edited posts in the first 24 hours.
- **Engage with every comment in the first 60 minutes.** If contractors share missed-call stories in the replies, respond personally — that thread velocity is the reach multiplier.
- **The 38% and $8,680 figures must stay as written.** Specificity is the credibility engine.
