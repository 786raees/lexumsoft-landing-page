...
And your Google Business Profile is the only thing that gets you there.

It's completely free. And most contractors are leaving it almost entirely untouched.

---

Here's what "untouched" usually looks like:

→ Only 1 or 2 business categories selected (when you can add up to 10)
→ Hours not updated for holidays or emergencies
→ Photos are either stock images or 3 blurry job site shots from 2021
→ Zero Google Posts in the last 6 months
→ Reviews going unresponded to for weeks
→ No Q&A section filled out

Every one of those gaps is a signal to Google that you're less active, less relevant, and less trustworthy than the competitor who filled theirs in.
...
Within 60 days he was ranking in the Map Pack for 14 new search terms in his service area.

Inbound calls from the free listing went up 73%.

He was already paying for ads to compete for the same customers he was now getting for free.
...
#PlumbingBusiness #HVACBusiness #GoogleBusinessProfile #LocalSEO #ContractorMarketing #PlumbingMarketing #HVACMarketing #MapPack #HomeServiceBusiness #ContractorGrowth
```
...
|---|---------|----------|------------|-------------|
| 1 | **The Invisible Storefront** | Midjourney v6.1 | Medium | Dark closed shop at night, Google Maps pin reflected in glass window, amber glow on wet sidewalk |
| 2 | **The Map Pack Throne** | Midjourney v6.1 | Hard | Aerial god's-eye view, 3 houses glowing amber-gold, rest dark, plumber's van in driveway |
| 3 | **The Unlocked Phone** (Recommended) | Ideogram v3 Design | Easy | Phone on dark surface, screen showing Google Maps 3-pack, amber glow as sole light source |
| 4 | **The Gold Mine** | Midjourney v6.1 | Medium | Oversized gold Google Maps pin planted in cracked desert earth, amber light seeping from cracks, wrench leaning against pin |

**Generation priority:** 3 → 4 → 1 → 2
**Typography:** All text, brand bars, and overlays are baked into the AI-generated image. No post-production step. Full specs in the prompts file.
